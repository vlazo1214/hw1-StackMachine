# $Id: Makefile,v 1.13 2023/01/12 15:39:52 leavens Exp leavens $
...
zip tests.zip: hw1-test*.txt Makefile
	chmod 755 hw1-test*.txt hw1-test*.out Makefile
	zip -9 ~/WWW/COP3402/homeworks/tests.zip hw1-test*.txt hw1-tests*.out Makefile
